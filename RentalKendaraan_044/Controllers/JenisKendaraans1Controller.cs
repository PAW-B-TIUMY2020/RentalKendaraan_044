...
using RentalKendaraan_044.Models;

namespace RentalKendaraan_044.Controllers
{
    public class JenisKendaraans1Controller : Controller
    {
        private readonly RentKendaraanContext _context;

        public JenisKendaraans1Controller(RentKendaraanContext context)
        {
            _context = context;
        }

        // GET: JenisKendaraans1
        public async Task<IActionResult> Index()
        {
            return View(await _context.JenisKendaraan.ToListAsync());
        }

        // GET: JenisKendaraans1/Details/5
        ...
        // GET: JenisKendaraans1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: JenisKendaraans1/Create
        ...
        // POST: JenisKendaraans1/Delete/5
